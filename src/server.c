...
#ifdef GGZSPECTATORS
void game_handle_ggz_spectator_join(GGZdMod * ggz, GGZdModEvent event,
				    const void *data)
{
  int i, fd;
...
void game_handle_ggz_spectator_leave(GGZdMod * ggz, GGZdModEvent event,
				     const void *data)
{
  if (seats_empty())
...
void game_handle_ggz_spectator(GGZdMod * ggz, GGZdModEvent event,
			       const void *data)
{
  int num = *(int *) data;
  int fd, op;
